...
// EU countries for conditional residence permit logic
const EU_COUNTRIES = [
  'Italia',
  'Austria',
  'Belgio',
...
const PERSONAL_INFORMATION_SECTION: FormSection = {
  ...
  fields: [
    ...
    // 4. Mobile phone with country code
    {
    ...
    // 8. Place of birth (Italy/Another country + Country dropdown)
    {
      ...
      subFields: [
        ...
        },
        {
          ...
          required: true,
          defaultValue: 'Italia',
          description: 'Seleziona il paese di nascita se diverso da Italia',
        },
      ],
    },
    // 9. Paese (Country)
    ...
    // 17. Tax Code / Health Card (file + text input)
    {
      ...
      subFields: [
        {
          name: 'tax_card_file',
          label: 'Carica tessera sanitaria',
          type: 'file',
          required: true,
          description: 'Allega la tessera sanitaria',
          accept: '.pdf,.jpg,.jpeg,.png',
        },
        {
          name: 'tax_code',
    ...
    // 18. Residence permit (for non-EU citizens)
    {
      ...
      subFields: [
        {
          name: 'permit_file',
          label: 'Allega permesso di soggiorno',
          type: 'file',
          required: true,
          description: 'Carica il permesso di soggiorno',
          accept: '.pdf,.jpg,.jpeg,.png',
        },
        {
        ...
        {
          name: 'receipt_file',
          label: 'Allega ricevuta (se permesso scaduto)',
          type: 'file',
          required: false,
          description: 'Obbligatorio se il permesso è scaduto',
          accept: '.pdf,.jpg,.jpeg,.png',
          conditionalOn: {
            field: 'permit_expired',
            equals: 'Sì',
          },
        },
      ],
